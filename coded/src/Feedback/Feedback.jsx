      ...
      <div className="bg-gradient-to-b from-black to-black h-screen w-screen">
        <div className="w-[600px] bg-gray-800 m-auto pt-[70px] p-3">
          ...
          <div className="m-3 text-white p-">
            ...
            <button
              type="button"
              class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-7 py-5 text-center me-2 mb-2 mt-3 ml-[43%] "
              onClick={submit}
            >
              Submit
            </button>
